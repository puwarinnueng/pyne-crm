...
function createConsentPdfHtml_(customer, visit) {
  ...
  return [
    ...
    '<meta charset="utf-8">',
    '<style>',
    // สี/ขนาดตาม Dev Style Guide v1.0 — Arial/Noto Sans Thai ท้ายชุดไว้ให้ตัว render PDF ฝั่ง Google
    // ที่ resolve -apple-system ไม่ได้ ส่วน .sub/.footer ใช้ Deep Bronze ไม่ใช่ Muted Taupe เพราะ
    // Taupe เป็น large/icon only ห้ามใช้กับตัวหนังสือต่ำกว่า 18px
    'body{font-family:-apple-system,BlinkMacSystemFont,Arial,"Noto Sans Thai",sans-serif;color:#261F1C;margin:32px;font-size:12px;line-height:18px;}',
    'h1{font-size:22px;line-height:28px;font-weight:600;margin:0 0 6px;color:#5E4737;}',
    'h2{font-size:16px;line-height:22px;font-weight:600;margin:22px 0 8px;color:#5E4737;border-bottom:1px solid #DFD8CE;padding-bottom:5px;}',
    '.sub{color:#866957;font-size:11px;line-height:16px;margin-bottom:16px;}',
    'table{width:100%;border-collapse:collapse;margin-bottom:10px;}',
    'th,td{border:1px solid #DFD8CE;padding:7px 9px;vertical-align:top;white-space:pre-wrap;word-break:break-word;}',
    'th{width:30%;background:#F0ECE4;text-align:left;font-weight:500;color:#866957;}',
    '.footer{margin-top:24px;color:#866957;font-size:11px;line-height:16px;}',
    '</style>',
    '</head>',
    '<body>',
